...
void SubLED::addGradiant(frc::Color iStartingColor, frc::Color iEndingColor, int iVectorSize, std::vector<frc::Color> * iModifiedVector)
{
...
void SubLED::setMouthLEDs(int iMouthSize)
{
...
void SubLED::pulseLEDs(frc::Color iPulseColor)
{
