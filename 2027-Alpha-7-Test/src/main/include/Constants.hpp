...
namespace PathPlannerConstants
{
	...
	inline constexpr wpi::units::meters_per_second_t kMaxVelocity = .3_mps;
	inline constexpr wpi::units::meters_per_second_squared_t kMaxAcceleration = 0.3_mps_sq;
	inline constexpr wpi::units::degrees_per_second_t kMaxAngularVelocity = 36.0_deg_per_s;
	inline constexpr wpi::units::degrees_per_second_squared_t kMaxAngularAcceleration = 72.0_deg_per_s_sq;
} // namespace PathPlannerConstants

namespace ChassisConstants
{
	// Left-Right
	inline constexpr wpi::units::meter_t kRobotWidth = 28_in;
	// Front-Back
	inline constexpr wpi::units::meter_t kRobotLength = 26.875_in;
	// In both directions
	inline constexpr wpi::units::meter_t kModuleCornerOffset = 1.75_in;

	// We take for granted a rectangular frame
	inline constexpr wpi::math::Translation2d kFrontLeftTranslation = wpi::math::Translation2d{(kRobotLength / 2 - kModuleCornerOffset), (kRobotWidth / 2 - kModuleCornerOffset)};
	inline constexpr wpi::math::Translation2d kFrontRightTranslation = wpi::math::Translation2d{(kRobotLength / 2 - kModuleCornerOffset), -(kRobotWidth / 2 - kModuleCornerOffset)};
	inline constexpr wpi::math::Translation2d kBackLeftTranslation = wpi::math::Translation2d{-(kRobotLength / 2 - kModuleCornerOffset), (kRobotWidth / 2 - kModuleCornerOffset)};
	inline constexpr wpi::math::Translation2d kBackRightTranslation = wpi::math::Translation2d{-(kRobotLength / 2 - kModuleCornerOffset), -(kRobotWidth / 2 - kModuleCornerOffset)};

	inline constexpr wpi::units::kilogram_t kRobotMass = 60_kg;
	inline constexpr wpi::units::kilogram_square_meter_t kRobotMOI = 6_kg_sq_m;
	inline constexpr wpi::units::kilogram_square_meter_t kModuleMOI = 0.0003917128_kg_sq_m; // 1.33855 lb*in^2
}
...
namespace ModuleConstants
{
	...
	inline constexpr wpi::units::volt_t kNominalVoltage = 12_V;                                 // The voltage at which the max speeds are mesured
	inline constexpr wpi::units::meter_t kWheelRadius = 1.341628_in;                            // The radius of REV's plastic wheels, masured with the wheelCaracterizationCommand
	inline constexpr wpi::units::meter_t kWheelPerimeter = kWheelRadius * 2 * std::numbers::pi; // in meters (diametre in inches * convertion to meters * pi)
	inline constexpr wpi::units::radians_per_second_t kTurningWheelFreeSpeedRadps = 24.260_rad_per_s;
	inline constexpr wpi::units::meters_per_second_t kDriveWheelMaxFreeSpeed = 4.9180_mps;
	...
	inline constexpr wpi::units::ampere_t kDrivingCurrentLimit = 80_A;
	inline constexpr wpi::units::ampere_t kTurningCurrentLimit = 20_A;
	...
	namespace Config
	{
		...
		inline constexpr wpi::units::revolutions_per_minute_t kTurningCruiseVelocity = 2_rad_per_s * std::numbers::pi;
		inline constexpr wpi::units::revolutions_per_minute_per_second_t kTurningMaxAcceleration = 4_rad_per_s_sq * std::numbers::pi;
...
{
	inline constexpr wpi::units::meters_per_second_t kAttainableSpeed = 4.50_mps;
	inline constexpr wpi::units::meters_per_second_t kMaxDesiredSpeed = 4.50_mps;
	inline constexpr wpi::units::radians_per_second_t kMaxDesiredAngularSpeed = std::numbers::pi * 3_rad_per_s;

	namespace Commands
	{
		inline constexpr wpi::units::second_t kMaxSpeedStartDelay = 2.0_s;
		inline constexpr wpi::units::meters_per_second_squared_t kMaxSpeedRampRate = 0.5_mps_sq;
		inline constexpr wpi::units::meters_per_second_t kMaxSpeedMaxVelocity = 5_mps;
		inline constexpr wpi::units::second_t kFeedforwartStartDelay = 2.0_s;
		inline constexpr robotixLib::templateUnits::VoltageInverse<wpi::units::seconds> kFeedforwardRampRate = 1_V / 1_s;
		inline constexpr wpi::units::second_t kWheelRadiusMeasurementStartDelay = 1.0_s;
		inline constexpr wpi::units::radians_per_second_t kWheelRadiusMaxVelocity = 0.25_rad_per_s;
		inline constexpr wpi::units::radians_per_second_squared_t kWheelRadiusRampRate = 0.05_rad_per_s_sq;
	} // namespace Commands
...
namespace LimelightConstants
{
	...
	inline constexpr wpi::units::meter_t kForward = 13.6875_in;
	inline constexpr wpi::units::meter_t kRight = -11.875_in;
	inline constexpr wpi::units::meter_t kUp = 20.875_in;

	inline constexpr wpi::units::degree_t kRoll = 0_deg;
	inline constexpr wpi::units::degree_t kPitch = 0_deg;
	inline constexpr wpi::units::degree_t kYaw = 0_deg;
